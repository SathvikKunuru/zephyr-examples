...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 125);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 160000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32U5_MSI_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SWJ_CONNECTOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CUSTOM_U575VIT6Q, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CUSTOM_U575VIT6Q_STM32U575XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32U5X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32U575XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_STM32U5_ERRATA_DMAT_AFFECTED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MAX_POWER, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_RINGBUF_SIZE, 256);
